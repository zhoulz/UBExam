...
//        messageJchock.setModel(new javax.swing.DefaultComboBoxModel(new String[] {  "考生姓名"}));
        ifLabel.setText("查询值：");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
            		"考生编号","考生姓名", "单选题得分", "多选题得分","判断题得分","技能得分","总分","考试时间"
            }
        ...
        java.util.List list = findGradebean.findGrade();
        		...
        		Grade grade = (Grade)list.get(j);
        		  model.addRow(new Object[] {
        				  grade.getId(),ChDeal.toChinese(grade.getUserName()),grade.getRadioResult(),
        					grade.getFullResule(),grade.getEsitResult(),grade.getBatsisResult(),grade.getSkillResult(), 
        ...
        downmessage.setText("海口联合农村商业银行股份有限公司");

        jLabel1.setText("携手创业,共同成长;持续学习,拥抱变化 ");
        ...
        jPanel1Layout.setHorizontalGroup(
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(messageJchock, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(downmessage, javax.swing.GroupLayout.PREFERRED_SIZE, 287, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(135, 135, 135))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(ifLabel)
                    .addComponent(messageJchock, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(messageLabel)
	...
	if(messageJchock.getSelectedItem().toString().equals("考生号")){
		...
		if(!gradeList.isEmpty()){
			...
			while(i<gradeList.size()){
				...
				if(grade.getId() == Integer.parseInt(nameField)){
...
*/					
			...
			if (i == 0){
				JOptionPane.showMessageDialog(this,
						"没有要查询的考生成绩！","信息对话框",JOptionPane.WARNING_MESSAGE);	
			}
		}		
	}	
...
/*		单笔查询
		...
		System.out.println("grade.getUserName() is: " + grade.getUserName() + "nameTextField.getText() is: " + nameTextField.getText() );
	    if((grade.getUserName().equals(nameTextField.getText()))&&(grage.getId()!=0))	{
			((DefaultTableModel) jTable1.getModel()).setRowCount(0);
			((DefaultTableModel) jTable1.getModel()).addRow(new Object[] {
    					grage.getUserName(),grage.getRadioResult(),
    					grage.getFullResule(),grage.getEsitResult(),grage.getBatsisResult(),grage.getSkillResult(), 
...
*/	    
	    ...
	    FindGrade findGrade = new FindGrade();
		java.util.List<Grade> gradeList = findGrade.findGrade();
		String nameField = nameTextField.getText().trim();
		int i = 0;
		if(!gradeList.isEmpty()){
			((DefaultTableModel) jTable1.getModel()).setRowCount(0);
			while(i<gradeList.size()){
				...
				if(grade.getUserName().trim().equals(nameField)){
					Grade gradeId = findGrade.getGradeID(grade);					
					((DefaultTableModel) jTable1.getModel()).addRow(new Object[] {
							grade.getId(),ChDeal.toChinese(grade.getUserName()),grade.getRadioResult(),
	        					grade.getFullResule(),grade.getEsitResult(),grade.getBatsisResult(),grade.getSkillResult(), 
