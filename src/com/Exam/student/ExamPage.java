...
//        contentPanel = new MySudentExamJPanel();
        ...
        Question ques = fin.getQuestion(question);
...
private void getGread(){
	...
	int sum = radioGrage + moreGrade + examGrade;
...
private void upjButtonActionPerformed(java.awt.event.ActionEvent evt) {
	String count = countjLabel.getText();
...
private void downjButtonActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    buttonGroup1.clearSelection();			
    String strid = "";
    if(radioList.size() > countText){
    	for(int i = 0;i<radioList.size();i++){
    		strid = radioList.get(countText).toString();    	
    	}
    }
    if(strid.equals("")){
    	radioanswer.setText("");
